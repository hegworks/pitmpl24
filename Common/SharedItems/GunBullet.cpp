...
GunBullet::GunBullet(Uknitty::ICamera* iCamera, Uknitty::ShaderProgram* shaderProgram, btDynamicsWorld* btDynamicsWorld) :
	DynamicObject(iCamera, nullptr, shaderProgram, btDynamicsWorld, INITIAL_POSITION, nullptr)
{
